...
export default function ForgotPasswordScreen({ navigation }) {
  ...
  const handleReset = async () => {
    ...
    try {
      ...
      Alert.alert('Thanh cong', 'Vui long kiem tra email de nhan mat khau moi.', [
        { text: 'OK', onPress: () => navigation.navigate('Login') },
      ]);
    } catch (err) {
      const msg = err.response?.data?.message || 'Khong the gui yeu cau!';
      setErrorMsg(msg);
    } finally {
      setLoading(false);
    }
      ...
      >
        ...
        >
          <View style={styles.card}>
            ...
            <Button title="Gui yeu cau" onPress={handleReset} variant="warning" loading={loading} />
