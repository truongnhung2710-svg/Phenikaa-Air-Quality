...
export default function App() {
  ...
  return (
    <div id="app-container" className={theme}>
      ...
      {/* 1. HIỂN THỊ CÁC MÀN HÌNH XÁC THỰC (Đăng nhập / Đăng ký / Quên MK) */}
      ...
      {/* 2. HIỂN THỊ GIAO DIỆN CHÍNH (Chỉ hiện khi view là 'app' - đã đăng nhập) */}
      {view === 'app' && (
        // ĐÃ SỬA: Thêm flex để ép Sidebar và Main Content nằm ngang hàng
        <div id="main-app" className="view active" style={{ display: 'flex', height: '100vh', width: '100vw', overflow: 'hidden' }}>
          
          {/* ĐÃ SỬA: Xóa đoạn style đẩy lùi thanh menu xuống dưới */}
